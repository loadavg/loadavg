...
$(document).ready(function(e) {
    ...
    //calculate column widths - need to add totals column
    //and we subtract width of time column
    var columnWidth = 91 / (totalModules+1);
	...
	for ( key in modules) {
		...
		//console.log(modules[key], elements );
    ...
    //chartArray comes from the php array chartArray
