...
charts.processor_load = 
{
	...
	setData: function($data)
	{
			...
			this.chartwidth = $data[0].chartwidth;
			this.chartheight = $data[0].chartheight;
	},
	...
	setRange: function($data1,$data2,$data3)
	{
		...
		this.setChartBarWidth($data3);
  		...
  		console.log(  $data3, "setRange in Proc");
