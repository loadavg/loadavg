...
charts.cpu_load = 
{
	...
	{		
        ...
        legend: { 	position: "nw", 
        			noColumns: 0,
            		margin: 0,
        			backgroundColor: "#000", backgroundOpacity: .4, 
		...
		xaxis: {mode: 'time',
			...
			timezone: null,  minTickSize: ["5", "minute"], timeformat: "%H",  min: today_min, max: today_max, ticks: 12 },
			...
			tooltipOpts: {
				...
				content: function(label, xval, yval, flotItem){
					...
					return "Load : " + parseFloat(yval).toFixed(2) + " / " + itemTime ;
