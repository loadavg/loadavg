...
charts.uptime_usage = 
{
	...
	options: 
	{
		...
		xaxis: {mode: 'time', timezone: "browser",  minTickSize: ["1", "hour"], timeformat: "%H",  min: today_min, max: today_max, ticks: 12 },
        colors: [],
        shadowSize:1,
        tooltip: true,
	...
	setData: function($data,$info)
	{
		...
		//console.log ("module passed timezone : ", $info.thetimezone );


		//this.options.xaxis.timezone = $info.thetimezone;


		console.log (">> in uptime.js <<");

		//min and max are set in header.php
		// *// 1000 us javascript using miliseconds

/*
		console.log ("today_min : ", today_min );
		formattedTime = this.timeConverter(today_min / 1000 );
		console.log ("today_min", formattedTime);

		console.log ("today_max : ", today_max );
		formattedTime = this.timeConverter(today_max  / 1000 );
		console.log ("today_max", formattedTime);
*/
